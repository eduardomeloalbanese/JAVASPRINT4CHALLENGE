...
import org.springframework.web.bind.annotation.CrossOrigin; // ✅ 1. ADICIONAR IMPORT

import java.util.List;

@RestController
@RequestMapping("/api/lembretes")
@CrossOrigin // ✅ 2. ADICIONAR (Para o Front-End (React) funcionar depois)
public class LembreteController {
    ...
    // ✅ 3. ADICIONAR O ENDPOINT @PUTMAPPING (A CORREÇÃO DO SEU ERRO)
    @PutMapping("/{id}")
